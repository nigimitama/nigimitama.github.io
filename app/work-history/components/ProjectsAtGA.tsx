...
Python, AWS, Docker, CircleCI, Rollbar
    ...
    },
    {
      ...
      summary: `マネージャー・経営陣のKPI把握のためのダッシュボード作成に従事`,
      markdown: `
## 概要
...
SQL, Tableau, Google App Script, TreasureData
    ...
    },
    {
      ...
      summary:
        "データに基づく「お客様と相性が良さそうな営業担当者」のレコメンドにより商談割り振りを最適化し、顧客体験と成約率の向上に寄与した",
      markdown: `
## 概要
...
Ruby on Rails, Python
    ...
    },
    {
      ...
      date: "2021 ~ ",
      title: "研修コンテンツ作成・運用",
      summary: "メンバーの専門知識向上のための研修コンテンツを作成・運用",
      markdown: `
## 概要
...
2024年ごろからは「研究力」の研修をリードする立場となった。
    ...
    },
    {
      ...
      summary: "事故物件の資産価値への影響を調査し、交渉のエビデンスとして貢献",
      markdown: `
## 背景
...
統計的因果推論
    ...
    },
    {
      ...
      summary: "マンションの専有部の設備や仕様から推測される「グレード感」を定量評価する研究",
      markdown: `
## 概要
...
具体的な作業は1人の私以外のメンバーが担当した。私はリーダーあるいはメンターのような立場で関わり、プロジェクトの方針のディスカッションを行ったり、ビジネス部門とのミーティングに同席したり、分析方針のアドバイスを行ったり、共同研究者の対応などのサポートを行った。
    ...
    },
    {
      ...
      summary: "賃料査定業務を効率化する社内向けSPA（TypeScript + React + Python）を開発し、45%程度の工数削減を実現",
      markdown: `
## 概要
...
他のメンバーが開発したアプリたちと連携した機能も存在し、それらを実装する際は当該メンバーにビジネスサイドの要求仕様を伝えて開発してもらうこともあった。
    ...
    },
    {
      ...
      summary: "マンションの共用部の設備や仕様から推測される「グレード感」を定量評価する研究",
      markdown: `
## 概要
