        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            >
              ...
              <span className={`w-6 h-0.5 bg-white mt-1 transition-all ${isOpen ? '-rotate-45 -translate-y-1.5' : ''}`}></span>
            </button>

            <ul className={`${isOpen ? 'block' : 'hidden'} md:flex md:space-x-6 absolute md:relative top-16 md:top-0 left-0 w-full md:w-auto bg-gray-800 md:bg-transparent p-4 md:p-0`}>
              <li>
                <Link 
                  href="/" 
